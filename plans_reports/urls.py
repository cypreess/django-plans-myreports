...
urlpatterns = patterns('',
    ...
    url(r'^invoiced/(?P<pk>\d+)/csv/$', staff_member_required(DetailView.as_view(model=InvoicedReport, template_name_suffix='detail_csv')), name='plans_raport_invoiced_csv'),
