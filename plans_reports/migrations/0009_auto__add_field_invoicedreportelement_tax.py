...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvoicedReportElement.tax'
        db.add_column('plans_reports_invoicedreportelement', 'tax',
                      self.gf('django.db.models.fields.DecimalField')(db_index=True, null=True, max_digits=4, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvoicedReportElement.tax'
        db.delete_column('plans_reports_invoicedreportelement', 'tax')
