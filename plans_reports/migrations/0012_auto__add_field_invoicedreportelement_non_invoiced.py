...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvoicedReportElement.non_invoiced'
        db.add_column('plans_reports_invoicedreportelement', 'non_invoiced',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvoicedReportElement.non_invoiced'
        db.delete_column('plans_reports_invoicedreportelement', 'non_invoiced')
    ...
    models = {
        ...
        'plans_reports.invoicedreportelement': {
            ...
            'non_invoiced': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
